...
// console.log([1] == "1");                                         // Output: true
// console.log([1] + "2");                                          // Output: 12
// console.log([3, 4] == "3,4");                                    // Output: true
// console.log([] + []);                                            // Output: ""
// console.log({} == true);                                         // Output: false
// console.log("" == 0);                                            // Output: true
// console.log("1" == 1);                                           // Output: true
// console.log([0] == false);                                       // Output: true
// console.log([] + {} == "[object Object]");                       // Output: true
// console.log([] == 0);                                            // Output: true
// console.log([1, 2] == true);                                     // Output: false
// console.log([3] == true);                                        // Output: false
// console.log([2, 3] + "test");                                    // Output: 2,3test
// console.log([0] + null);                                         // Output: 0null
// console.log([1, 2] == 12);                                       // Output: false
...
// console.log("false" == false);                                   // Output: false
// console.log(true + true + "test");                               // Output: 2test
...
// console.log(0 > 1 || "test" == "test");                          // Output: true
// console.log((1 && "true") || false);                             // Output: true
// console.log(null || undefined);                                  // Output: undefined
// console.log(undefined || null);                                  // Output: null
// console.log("app" === "app" && "ban" < "che");                   // Output: true
// console.log(0 && "false");                                       // Output: 0
// console.log("false" == "false" || 1 > 0);                        // Output: true
// console.log(true === true && false === false);                   // Output: true
// console.log(4 < 5 && 6 > 7);                                     // Output: false
// console.log("" || "empty");                                      // Output: "empty"
// console.log("he" == "he" || "wor" == "wor");                     // Output: true
// console.log(3 > 1 && "apple" === "apple");                       // Output: true
...
// console.log({} + [] == "[object Object]");                       // Output: true
// console.log(null == undefined);                                  // Output: true
// console.log([].push(1) == 1);                                    // Output: true
// console.log([10] == 10);                                         // Output: true
// console.log([1] == "1");                                         // Output: true
// console.log("a" + +"b" + "c");                                   // Output: aNanNc
// console.log(0 == 0);                                             // Output: true
// console.log(0 == "0");                                           // Output: true
// console.log(0 == false);                                         // Output: true
// console.log("" == 0);                                            // Output: true
...
// console.log([] + null);                                          // Output: null
// console.log([undefined] == undefined);                           // Output: false
// console.log(5 == "5" && "apple" == "banana");                    // Output: false
